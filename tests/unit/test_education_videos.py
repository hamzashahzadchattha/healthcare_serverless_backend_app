...
MOCK_CONDITION_ROW = {"patient_found": True, "condition_name": "Type 2 Diabetes", "icd10_code": "E11.9"}

MOCK_SENTINEL_ROW = {"patient_found": True, "condition_name": None, "icd10_code": None}
...
class TestEducationService:
    ...
    def test_no_conditions_returns_empty(self):
        ...
        with patch(
            "src.education.service.repository.get_active_conditions",
            return_value=[MOCK_SENTINEL_ROW],
        ):
