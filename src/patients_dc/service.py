"""Business logic for patient registration — dataclass benchmark variant.

Identical logic to src/patients/service.py. Uses stdlib hashlib + bcrypt only.
No Pydantic dependency anywhere in this module or its imports.
"""
...
from src.patients_dc import repository
from src.patients_dc.models import PatientRegistrationRequest, PatientRegistrationResponse
...
def register_patient(payload: PatientRegistrationRequest) -> PatientRegistrationResponse:
    ...
    Args:
        payload: Validated PatientRegistrationRequest dataclass instance.

    Returns:
        PatientRegistrationResponse dataclass with the new patient_id and status.
